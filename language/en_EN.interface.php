<?php
    return [
		...
		'tr_meliscmspagescripteditor_head_top' => 'Head Top (after <head> opening tag)', 
		'tr_meliscmspagescripteditor_head_top tooltip' => 'Set the scripts to be inserted after the opening head tag (<head>)',
		'tr_meliscmspagescripteditor_head_bottom' => 'Head Bottom (before </head> closing tag)', 
		'tr_meliscmspagescripteditor_head_bottom tooltip' => 'Set the scripts to be inserted before the closing head tag (</head>)',
		'tr_meliscmspagescripteditor_body_bottom' => 'Body Bottom (before </body> closing tag)', 
